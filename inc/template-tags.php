...
function back_to_front_starter_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'back_to_front_starter_categories' ) ) ) {
		...
		set_transient( 'back_to_front_starter_categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so back_to_front_starter_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so back_to_front_starter_categorized_blog should return false.
		return false;
	}
}
...
add_action( 'edit_category', 'back_to_front_starter_category_transient_flusher' );
